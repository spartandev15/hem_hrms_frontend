...
import useDebouncedSearch from "../../hooks/useDebounce";
import { useAppDispatch, useAppSelector } from "../../hooks/reduxHook";
import { useDeleteEmployeeMutation } from "../../redux/api/employee";
import { setIsLoading } from "../../redux/slices/loadingSlice";
import { setToast } from "../../redux/slices/toastSlice";
          ...
          {isLoading ? (
            ...
            data.map((record:any, index:any) => (
              <TableRow
                ...
                record={record}
                index={index}
                onEdit={() => setSelectedEmployee(record)}
              />
            ))
          ) : (
            <tr>
...
/* ===========================================
   TABLE ROW IN SAME FILE
=========================================== */

const TableRow = ({ record, onEdit }:any) => {
  const dispatch = useAppDispatch();
  ...
  const handleDelete = async (isConfirm:any) => {
    if (!isConfirm) {
      setIsOpenDialog(false);
      return;
    }
